...
const commandPaletteCopyByLocale: LocalizedValue<CommandPaletteCopy> = {
  zh: {
    ...
    dialogDescription: "搜索首页能力矩阵、典型场景、关于、演进、Lab 或终端页；外链为源码协作、版本发布与快速上手。",
    ...
    items: [
      ...
      {
        description: "文档化履历：简介、技能、路线与开源入口",
        group: "pages",
        id: "page-resume",
        keywords: ["resume", "简历", "履历", "cv"],
        label: "履历",
        type: "route",
        url: "/resume",
      },
      ...
      {
        description: "源码、Issue、讨论区与贡献入口",
        group: "links",
        id: "link-github",
        keywords: ["github", "source", "code", "开源", "源码", "协作"],
        label: "源码协作",
        type: "external",
  ...
  en: {
    ...
    items: [
      ...
      {
        description: "Document-style resume and capability overview",
        group: "pages",
        id: "page-resume",
      ...
      {
        description: "Source, issues, discussions, and contributing",
        group: "links",
        id: "link-github",
        keywords: ["github", "source", "code", "collab", "open source"],
        label: "Source & collab",
        type: "external",
        url: siteLinks.github,
      },
