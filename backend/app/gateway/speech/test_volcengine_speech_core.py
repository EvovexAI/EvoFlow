...
class TestLoadCredentials:
    ...
    def test_agent_plan_credentials(self, mock_get_creds, mock_apply):
    ...
    def test_standard_credentials(self, mock_get_creds, mock_apply):
        mock_get_creds.return_value = {}
        result = _load_credentials()
    ...
    @patch("evoflow.persistence.media_settings.get_media_credentials")
    @patch.dict(os.environ, {}, clear=True)
    def test_empty_credentials_returns_empty(self, mock_get_creds, mock_apply):
        mock_get_creds.return_value = {}
        result = _load_credentials()
        assert result[0] == ""
        assert result[4] is False
...
class TestSpeechConfigured:
    ...
    def test_configured_returns_true(self, mock_load, mock_vendors):
    ...
    @patch("app.gateway.speech.volcengine_speech.get_enabled_vendors")
    @patch("app.gateway.speech.volcengine_speech._load_credentials")
    def test_disabled_vendor_returns_false(self, mock_load, mock_vendors):
    ...
    @patch("app.gateway.speech.volcengine_speech.get_enabled_vendors")
    @patch("app.gateway.speech.volcengine_speech._load_credentials")
    def test_missing_key_returns_false(self, mock_load, mock_vendors):
        mock_vendors.return_value = {"volcengine-tts": True}
...
class TestSynthesizeSpeechV3:
    ...
    def test_success_standard_key(self, mock_client_cls, mock_require):
    ...
    @patch("app.gateway.speech.volcengine_speech._require_credentials")
    @patch("app.gateway.speech.volcengine_speech.httpx.Client")
    def test_success_agent_plan(self, mock_client_cls, mock_require):
    ...
    @patch("app.gateway.speech.volcengine_speech._require_credentials")
    @patch("app.gateway.speech.volcengine_speech.httpx.Client")
    def test_http_error_raises(self, mock_client_cls, mock_require):
    ...
    @patch("app.gateway.speech.volcengine_speech._require_credentials")
    @patch("app.gateway.speech.volcengine_speech.httpx.Client")
    def test_with_speaker_and_preview(self, mock_client_cls, mock_require):
