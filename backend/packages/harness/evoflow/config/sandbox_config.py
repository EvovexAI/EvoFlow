...
class SandboxConfig(BaseModel):
    ...
    Common options:
        use: Class path of the sandbox provider (required).
            Desktop default: ``evoflow.sandbox.noop:NoopSandboxProvider``
            (upload placeholder; no process isolation).
            Real isolation: ``evoflow.community.aio_sandbox:AioSandboxProvider``.
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: evo-flow-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. evoflow.sandbox.noop:NoopSandboxProvider or AioSandboxProvider)",
    )
    # Deprecated: LocalSandbox host bash was removed. Kept so old YAML still loads.
    allow_host_bash: bool = Field(
        default=False,
        description="Deprecated/ignored. LocalSandbox was removed; use terminal (host_direct) or AIO bash.",
        deprecated=True,
    )
