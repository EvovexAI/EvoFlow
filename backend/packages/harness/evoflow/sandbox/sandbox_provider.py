...
def _resolve_provider_class(use: str):
    """Resolve provider class; migrate deleted LocalSandboxProvider → Noop."""
    import logging
    ...
    return resolve_class(raw, SandboxProvider)
...
def get_sandbox_provider(**kwargs) -> SandboxProvider:
    ...
    if _default_sandbox_provider is None:
        ...
        cls = _resolve_provider_class(config.sandbox.use)
