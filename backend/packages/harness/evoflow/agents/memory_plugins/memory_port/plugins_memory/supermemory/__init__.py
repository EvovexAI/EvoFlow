...
_CONTEXT_STRIP_RE = re.compile(r"<supermemory-context>[\s\S]*?</supermemory-context>\s*", re.DOTALL)
_CONTAINERS_STRIP_RE = re.compile(r"<supermemory-containers>[\s\S]*?</supermemory-containers>\s*", re.DOTALL)
...
class _SupermemoryClient:
    ...
    def add_memory(self, content: str, metadata: dict | None = None, *, entity_context: str = "", container_tag: str | None = None, custom_id: str | None = None) -> dict:
    ...
    def search_memories(self, query: str, *, limit: int = 5, container_tag: str | None = None, search_mode: str | None = None) -> list[dict]:
        tag = container_tag or self._container_tag
    ...
    def get_profile(self, query: str | None = None, *, container_tag: str | None = None) -> dict:
        tag = container_tag or self._container_tag
