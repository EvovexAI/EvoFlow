...
QUERY_SCHEMA = {
    "name": "brv_query",
    "description": (
        "Search ByteRover's persistent knowledge tree for relevant context. Returns memories, project knowledge, architectural decisions, and patterns from previous sessions. Use for any question where past context would help."
    ),
    "parameters": {
        "type": "object",
        "properties": {
