...
def test_openai_host_gets_v1_embeddings() -> None:
    assert openai_compat_embeddings_url("https://api.openai.com") == "https://api.openai.com/v1/embeddings"


def test_openai_v1_base_not_doubled() -> None:
    assert openai_compat_embeddings_url("https://api.openai.com/v1") == "https://api.openai.com/v1/embeddings"


def test_ark_api_v3_no_extra_v1() -> None:
    assert openai_compat_embeddings_url("https://ark.cn-beijing.volces.com/api/v3") == "https://ark.cn-beijing.volces.com/api/v3/embeddings"


def test_ark_agent_plan_base() -> None:
    assert openai_compat_embeddings_url("https://ark.cn-beijing.volces.com/api/plan/v3") == "https://ark.cn-beijing.volces.com/api/plan/v3/embeddings"


def test_ark_coding_plan_base() -> None:
    assert openai_compat_embeddings_url("https://ark.cn-beijing.volces.com/api/coding/v3") == "https://ark.cn-beijing.volces.com/api/coding/v3/embeddings"
