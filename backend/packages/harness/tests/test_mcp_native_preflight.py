...
def test_permanent_native_failure_sqlite_vec():
    assert mr._looks_like_permanent_native_failure("sqlite-vec: Error: The specified module could not be found. getLoadablePath")
...
def test_abi_mismatch_is_not_permanent():
    ...
    assert not mr._looks_like_permanent_native_failure("Error: The module was compiled against a different Node.js version (NODE_MODULE_VERSION). ERR_DLOPEN_FAILED")
