...
def test_echo_redirect_chain_requires_approval() -> None:
    cmd = 'echo "临时文件" > D:/dev/coding/temp/test_again.txt; if (Test-Path D:/dev/coding/temp/test_again.txt) { Remove-Item D:/dev/coding/temp/test_again.txt; Write-Host "ok" }'
