...
_(Person Kernel L0: this Identity block is extracted into ``identity_md`` and treated as read-only at runtime. Do not put mutable habits here — put those under Core Traits / Lessons.)_
