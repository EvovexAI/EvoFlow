...
Workflows: `embedded-captions`, `faceless-explainer`, `motion-graphics`, `music-to-video`, `pr-to-video`, `product-launch-video`, `remotion-to-hyperframes`, `slideshow`, `talking-head-recut`, `general-video`, `media-use`.
