...
```text
/skills/downloads/evoflow-admin-external-1.0.5.zip
/skills/downloads/evoflow-admin-external-1.0.5.skill
...
```text
从官网 /skills/downloads/evoflow-admin-external-1.0.5.zip 下载，校验 SHA256 后安装到 EvoFlow。
```
