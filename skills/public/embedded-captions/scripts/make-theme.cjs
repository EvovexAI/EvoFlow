...
if (!heroInline && !HEROLESS) {
  if (dna.hero.setpiece === "detonation") {
    ...
    throw new Error(
      "[make-theme] coverword setpiece removed for license compliance. Use neon / slam / another setpiece instead.",
    );
  }
...
function setpieceCoverword() {
  throw new Error(
    "[make-theme] coverword setpiece removed for license compliance (CDPR fan-kit assets not redistributed).",
  );
}
