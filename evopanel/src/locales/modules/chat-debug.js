...
export default {
  ...
  evopanelReady: _('EvoFlow 就绪', 'EvoFlow Ready', 'EvoFlow 就緒'),
  ...
  diagCliNotInstalled: _('EvoFlow CLI 未安装，请前往「初始设置」页面安装', 'EvoFlow CLI not installed, please go to Setup page to install', 'EvoFlow CLI 未安裝，請前往「初始設定」頁面安裝'),
  ...
  installCorrupt: _('EvoFlow 安装可能已损坏', 'EvoFlow installation may be corrupted', 'EvoFlow 安裝可能已損壞'),
  ...
  installCorruptToast: _('EvoFlow 安装可能损坏，请打开「面板设置」排查或重装。', 'EvoFlow installation may be broken; open Settings to troubleshoot', 'EvoFlow 安裝可能損壞，請打開「面板設定」排查或重裝。'),
  ...
  cliUnavailable: _('EvoFlow CLI 不可用', 'EvoFlow CLI unavailable'),
