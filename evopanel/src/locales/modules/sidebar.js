...
export default {
  ...
  assistant: _('助手', 'Assistant', '助手', 'アシスタント', '어시스턴트', 'Trợ lý', 'Asistente', 'Assistente', 'Ассистент', 'Assistant', 'Assistent'),
  ...
  assets: _('资产中心', 'Assets', '資產中心', 'アセット', '자산', 'Tài sản', 'Activos', 'Ativos', 'Активы', 'Actifs', 'Vermögen'),
  cron: _('自动化', 'Cron Jobs', '自動化', 'スケジュールタスク', '예약 작업', 'Tác vụ định kỳ', 'Tareas', 'Tarefas', 'Планировщик', 'Tâches planifiées', 'Geplante Aufgaben'),
