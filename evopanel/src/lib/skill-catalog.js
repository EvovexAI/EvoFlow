...
const SKILL_ICON_MAP = [
  ...
  [/notion|wiki|markdown|note|write|doc/i, '📝'],
...
export const SKILL_TAGS = [
  ...
  { key: 'docs', label: '文档办公', icon: '📄', color: '#3b82f6', patterns: [/pdf|document|docx|word|office|read.pdf|excel|spreadsheet|sheet|csv|xlsx|pptx|slide|presentation|powerpoint|notion|wiki|markdown|note|write|doc/i] },
