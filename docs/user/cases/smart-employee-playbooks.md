...
2. **同级要对齐**用 **派发 / 小V / 同事叫醒**，不要硬填同级当 handlers。
...
| [4. 内容 + 运营工作室](#4-内容--运营工作室) | 新媒体、品牌小团队 | 周期值班 + 小V 临时稿 |
...
1. 你在小V 里对「发版专员」说：目标「今晚发 0.3.8，对照 checklist」。  
...
开值班、偶发小V 派活、确认完成；几乎碰不到「同意派发」（因为没有下级流水线）。
...
| **对外口径稿** | 写说明/更新文案 | 平时少心跳；靠小V 委派「写 0.3.8 更新说明」 |
...
3. 周五你小V 对口径稿：「根据本周三篇笔记写对外周报提纲」——**不必改岗位职责**。
...
4. 临时要「给投资人一页纸」：老板对小V 点名简报岗委派，不必改职责。
...
4. 周五小V 对学情岗：「把本周测验错题归进错题本目录」——同级叫醒或你派发均可。
...
2. 你学完后小V：「整理今天《政经》笔记」→ 笔记岗归类并出「明日复习三点」。  
