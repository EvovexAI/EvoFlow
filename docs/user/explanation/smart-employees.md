...
| **跨岗叫醒** | 同级前端叫醒后端对齐契约；小V / 你点名某岗 | 派发或让员工 wake 同事 |
| **临时委派** | 今天让运营岗出对外说明 | 小V 选员工发目标 |
...
| **叫醒 / 派发** | 同事跨岗派发、小V 催办派发、用户派发 | **任意在岗（active）同事**，含同级；不校验汇报线 | 员工页「派发任务」、小V 委派、主聊天相关派发、同事 wake、事件触发 |
...
| **小V 委派** | 小V → 对话 → 选员工 | 一员工一会话下目标（来源记为小V 催办派发） |
...
| **C. 你派发 / 小V** | 人 | 任意在岗 | 你自己就是调度，无「同意派发」 |
...
```text
开启自动上班 + 该岗上班中
    → 自动上班 / 现在开始工作 / 你或小V派发 / 同事wake / 正式交工被叫醒
...
sequenceDiagram
  ...
  BE->>BE: 改接口说明并回复进展
  Note right of You: 你也可以小V或派发分别点名两人
