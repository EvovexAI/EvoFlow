...
- **自动化**：到点跑固定 Prompt，适合日报、巡检等机械重复的工作
- **智能体员工**：为角色排班，定时上岗、审批、交班写报告
...
本项目以 [EvovexAI 非商业许可证 1.0](https://github.com/EvovexAI/EvoFlow/blob/main/LICENSE) 发布：**允许学习与非商业使用；商业使用须书面授权**（[cloud@evovexai.com](mailto:cloud@evovexai.com)）。
