...
文档贡献者请参考术语表，并参考仓库内 `docs/system/internal/` 下的 SSOT 索引与写作规范。

- [术语表](../../user/meta/glossary.md) — 统一术语
- SSOT 索引：`docs/system/internal/meta-ssot.md`
- 写作规范：`docs/system/internal/meta-writing-style.md`
