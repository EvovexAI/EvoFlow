...
![确认 Claude Code](../assets/cases/claude-code-step1.png)
...
![选择执行模式](../assets/cases/claude-code-step2.png)
...
![输入编码任务](../assets/cases/claude-code-step3.png)
...
![委托 Claude Code](../assets/cases/claude-code-step4.png)
...
![执行过程](../assets/cases/claude-code-step5.png)
...
![审查变更](../assets/cases/claude-code-step6.png)
...
![持续迭代](../assets/cases/claude-code-step7.png)
