...
本目录存放需求、设计草案、验收说明、历史长文与第三方参考资料等，**默认不进入 MkDocs 站点**（见仓库根目录 `mkdocs.yml` 的 `exclude_docs`）。

- 对外读者请使用站点中的 [快速开始](../getting-started/introduction.md)、[操作指南](../guides/configuration/evopanel-guide.md)、[参考手册](../reference/api-reference.md) 等页面。
